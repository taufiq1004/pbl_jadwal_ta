    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="landingpages.blade.php#hero" class="active">Home</a></li>
                    <li><a href="index.html#about">Berita</a></li>
                    <li><a href="index.html#services">Team</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <p data-aos="fade-up" data-aos-delay="200">Di sistem informasi penjadwalan TA</p>
                    </div>
                </div>
            </div>
...
{{-- Berita Content --}}
    ...
    <footer id="footer" class="footer">
        ...
        <div class="container copyright text-center mt-4">
            <p>&copy; <span>Copyright</span> <strong class="px-1">Teknologi Informasi</strong>
            </p>
            <div class="credits">
